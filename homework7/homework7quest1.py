...
class Matrix:
    ...
    def __add__(self, other):
        # empty_matrix = self.matrix1
        # for el in range(len(empty_matrix)):
        # for i in range(len(empty_matrix[el])):
        # empty_matrix[el][i] = empty_matrix[el][i] + other.matrix1[el][i]
        # return empty_matrix
        summ_matix = [[a + b for a, b in zip(i, j)] for i, j in zip(self.matrix1, other.matrix1)]
        return Matrix(summ_matix)


matrix_11 = [[31, 22], [37, 43], [1, 86]]
